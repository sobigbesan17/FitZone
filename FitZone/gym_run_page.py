...
class GymManager:
    ...
    def _apply_shared_page_callbacks(self, page):
        try:
            ...
            page.meal_planner_callback = self.show_meal_planner
            page.workout_planner_callback = self.show_workout_planner
            ...
            page.calculate_bmi_callback = self.show_calculate_bmi
            page.gym_class_clashes_callback = self.show_class_clashes
            page.gym_class_booking_callback = self.show_class_booking
            page.reviews_callback = self.show_reviews
            page.modify_classes_callback = self.show_leave_class
            page.view_class_reservations_callback = self.show_class_reservations
            page.view_fitness_dashboard_callback = self.show_fitness_dashboard
    ...
    def show_meals(self):
        ...
        page = GymMealPage(
            ...
            location_id=self.location_id,
            home_callback=self.show_home,
            dashboard_callback=self.show_fitness_dashboard,
        )
        self._display_page(page)
